---
title: How to Set Up Workspace Hooks | Sortie
...
For the full hooks schema, see the [WORKFLOW.md reference](../reference/workflow-config.md). For hooks in SSH-distributed setups, see [scaling agents with SSH](scale-agents-with-ssh.md).
