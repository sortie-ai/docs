---
title: "How to Use Sortie in Docker | Sortie"
...
- A working `WORKFLOW.md` tested locally ([quick start](../getting-started/quick-start.md))
...
For tracker setup details, see [How to connect to GitHub Issues](connect-to-github.md) or [How to connect to Jira](connect-to-jira.md).
