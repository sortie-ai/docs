---
title: How to Use Sub-Agents with Sortie | Sortie
...
- A `WORKFLOW.md` with hooks that clone the repo into the workspace ([workspace hooks guide](setup-workspace-hooks.md))
