---
title: How to Use the File Adapter for Local Testing | Sortie
...
For the full configuration schema, see the [WORKFLOW.md reference](../reference/workflow-config.md). For template syntax and available variables, see [How to write a prompt template](write-prompt-template.md).
