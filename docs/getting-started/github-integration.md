---
title: "Connect Sortie to GitHub Issues | Sortie"
...
- [Quick start](quick-start.md) completed
...
- Read the [GitHub adapter reference](../reference/adapter-github.md) for field mapping, state derivation, and rate limiting details.
