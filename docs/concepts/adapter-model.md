...
- [Architecture overview](architecture.md) — the single-binary design, layer model, and spec-first philosophy
- [Orchestration](orchestration.md) — how the dispatch-retry-reconcile loop uses adapter interfaces
