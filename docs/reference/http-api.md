...
Returns `text/plain` with Prometheus metric families. For the full metric catalog — names, labels, types, PromQL examples, and cardinality model — see [Prometheus metrics reference](prometheus-metrics.md).
